...
@Schema(name = "Resources", description = "A container's resources (cgroups config, ulimits, etc)")
...
public class Resources {
  ...
  */
  ...
  public Resources blkioWeightDevice(List<@Valid ResourcesBlkioWeightDeviceInner> blkioWeightDevice) {
    this.blkioWeightDevice = blkioWeightDevice;
    return this;
  }

  public Resources addBlkioWeightDeviceItem(ResourcesBlkioWeightDeviceInner blkioWeightDeviceItem) {
  ...
  */
  ...
  public Resources ulimits(List<@Valid ResourcesUlimitsInner> ulimits) {
    this.ulimits = ulimits;
    return this;
  }

  public Resources addUlimitsItem(ResourcesUlimitsInner ulimitsItem) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cpuShares, resources.cpuShares) &&
        ...
        equalsNullable(this.init, resources.init) &&
        equalsNullable(this.pidsLimit, resources.pidsLimit) &&
