...
@JsonTypeName("ConfigCreate_request")
...
public class ConfigCreateRequest {
  ...
  */
  ...
  public ConfigCreateRequest labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }

  public ConfigCreateRequest putLabelsItem(String key, String labelsItem) {
    if (this.labels == null) {
  ...
  */
  ...
  public ConfigCreateRequest data(String data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  public ConfigCreateRequest templating(Driver templating) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, configCreateRequest.name) &&
        Objects.equals(this.labels, configCreateRequest.labels) &&
        Objects.equals(this.data, configCreateRequest.data) &&
        Objects.equals(this.templating, configCreateRequest.templating);
  }
